...
int main() {
    ...
    queue<vector <bool>> p; // p - очередь состояний, соответствующих множествам, состоящих из состояний НКА.
    map <vector <bool>, int> bitsetToInt; // массив множеств, соответствующих состояниям ДКА.
